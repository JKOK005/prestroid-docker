...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 163 and 163+10 
             or ss_coupon_amt between 15042 and 15042+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 16630 and 16630+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 5783 and 5783+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 15070 and 15070+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 44 and 44+10
          or ss_coupon_amt between 581 and 581+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 2 and 2+10
          or ss_coupon_amt between 8694 and 8694+1000
