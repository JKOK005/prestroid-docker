-- start query 25 in stream 19 using template query28.tpl
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 158 and 158+10 
             or ss_coupon_amt between 15430 and 15430+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 43 and 43+10
          or ss_coupon_amt between 2629 and 2629+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 4 and 4+10
          or ss_coupon_amt between 4716 and 4716+1000
