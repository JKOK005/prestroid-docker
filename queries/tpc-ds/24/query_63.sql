-- start query 62 in stream 24 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 15702 and 15702+28800 
 	and sm_carrier in ('MSC','ORIENTAL')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
