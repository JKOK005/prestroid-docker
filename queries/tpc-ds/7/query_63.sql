-- start query 62 in stream 7 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'MSC' || ',' || 'HARMSTORF' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 10239 and 10239+28800 
 	and sm_carrier in ('MSC','HARMSTORF')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
