...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 85 and 85+10 
             or ss_coupon_amt between 11849 and 11849+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 20 and 20+10
          or ss_coupon_amt between 6578 and 6578+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 176 and 176+10
          or ss_coupon_amt between 15556 and 15556+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 138 and 138+10
          or ss_coupon_amt between 14885 and 14885+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 144 and 144+10
          or ss_coupon_amt between 16217 and 16217+1000
