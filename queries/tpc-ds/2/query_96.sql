-- start query 95 in stream 2 using template query10a.tpl
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('Chippewa County','Staunton city','Ketchikan Gateway Borough','Lucas County','Flagler County') and
