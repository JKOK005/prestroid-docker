-- start query 62 in stream 8 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'BARIAN' || ',' || 'ALLIANCE' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 19952 and 19952+28800 
 	and sm_carrier in ('BARIAN','ALLIANCE')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
