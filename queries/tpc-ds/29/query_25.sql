-- start query 25 in stream 29 using template query28.tpl
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 16 and 16+10 
             or ss_coupon_amt between 1458 and 1458+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 181 and 181+10
          or ss_coupon_amt between 5820 and 5820+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 90 and 90+10
          or ss_coupon_amt between 4860 and 4860+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 12 and 12+10
          or ss_coupon_amt between 11925 and 11925+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 15602 and 15602+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 37 and 37+10
          or ss_coupon_amt between 9995 and 9995+1000
