-- start query 25 in stream 26 using template query28.tpl
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 107 and 107+10 
             or ss_coupon_amt between 17341 and 17341+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 183 and 183+10
          or ss_coupon_amt between 674 and 674+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 6 and 6+10
          or ss_coupon_amt between 5636 and 5636+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 66 and 66+10
          or ss_coupon_amt between 9615 and 9615+1000
