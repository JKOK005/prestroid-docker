...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 165 and 165+10 
             or ss_coupon_amt between 3965 and 3965+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 164 and 164+10
          or ss_coupon_amt between 16097 and 16097+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 154 and 154+10
          or ss_coupon_amt between 3368 and 3368+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 99 and 99+10
          or ss_coupon_amt between 4669 and 4669+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 84 and 84+10
          or ss_coupon_amt between 4515 and 4515+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 11 and 11+10
          or ss_coupon_amt between 1238 and 1238+1000
