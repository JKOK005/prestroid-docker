...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 71 and 71+10 
             or ss_coupon_amt between 16456 and 16456+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 187 and 187+10
          or ss_coupon_amt between 288 and 288+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 48 and 48+10
          or ss_coupon_amt between 13141 and 13141+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 1 and 1+10
          or ss_coupon_amt between 17682 and 17682+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 97 and 97+10
          or ss_coupon_amt between 16553 and 16553+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 150 and 150+10
          or ss_coupon_amt between 15778 and 15778+1000
