...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 174 and 174+10 
             or ss_coupon_amt between 10094 and 10094+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 97 and 97+10
          or ss_coupon_amt between 8546 and 8546+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 47 and 47+10
          or ss_coupon_amt between 10342 and 10342+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 43 and 43+10
          or ss_coupon_amt between 5451 and 5451+1000
