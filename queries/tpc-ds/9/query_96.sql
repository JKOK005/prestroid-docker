-- start query 95 in stream 9 using template query10a.tpl
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('Marshall County','Cameron County','Penobscot County','Georgetown County','McCurtain County') and
