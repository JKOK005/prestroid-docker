-- start query 25 in stream 9 using template query28.tpl
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 109 and 109+10 
             or ss_coupon_amt between 13290 and 13290+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 27 and 27+10
          or ss_coupon_amt between 3842 and 3842+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 6335 and 6335+1000
