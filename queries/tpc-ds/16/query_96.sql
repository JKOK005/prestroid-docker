-- start query 95 in stream 16 using template query10a.tpl
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('Shelby County','Stewart County','Prince George County','Adams County','Trousdale County') and
