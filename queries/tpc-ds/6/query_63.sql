-- start query 62 in stream 6 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 46284 and 46284+28800 
 	and sm_carrier in ('ORIENTAL','UPS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
