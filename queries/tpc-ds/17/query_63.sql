-- start query 62 in stream 17 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 7850 and 7850+28800 
 	and sm_carrier in ('USPS','RUPEKSA')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
