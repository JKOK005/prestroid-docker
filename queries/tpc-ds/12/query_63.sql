-- start query 62 in stream 12 using template query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'BOXBUNDLES' || ',' || 'FEDEX' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 18410 and 18410+28800 
 	and sm_carrier in ('BOXBUNDLES','FEDEX')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
