-- start query 25 in stream 25 using template query28.tpl
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 143 and 143+10 
             or ss_coupon_amt between 7005 and 7005+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 159 and 159+10
          or ss_coupon_amt between 5689 and 5689+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 31 and 31+10
          or ss_coupon_amt between 737 and 737+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 57 and 57+10
          or ss_coupon_amt between 9902 and 9902+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 142 and 142+10
          or ss_coupon_amt between 2106 and 2106+1000
